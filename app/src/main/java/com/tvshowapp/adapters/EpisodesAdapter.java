...
import com.tvshowapp.databinding.ItemContainerEpisodeBinding;
import com.tvshowapp.models.Episode;
...
public class EpisodesAdapter extends RecyclerView.Adapter<EpisodesAdapter.EpisodesViewHolder> {
    ...
    public EpisodesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ItemContainerEpisodeBinding itemContainerEpisodeBinding = DataBindingUtil.inflate(layoutInflater, R.layout.item_container_episode,
                parent, false);
